...
mercury = Entity(model='sphere',color=color.red, scale=0.2)
venus = Entity(model='sphere',color=color.orange, scale=0.3)
earth = Entity(model='sphere',color=color.green, scale=0.4)
mars = Entity(model='sphere',color=color.brown, scale=0.3)
jupiter = Entity(model='sphere',color=color.gray, scale=0.6)
saturn = Entity(model='sphere',color=color.gold, scale=0.5)
uranus = Entity(model='sphere',color=color.cyan, scale=0.5)
neptune = Entity(model='sphere',color=color.blue, scale=0.5)
pluto = Entity(model='sphere',color=color.violet, scale=0.2)
